...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        const response = await fetch("https://moreorless.up.railway.app/api/movies");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://moreorless.up.railway.app/api/movies").then(async (response) => {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    searchInput.addEventListener("input", async () => {
        ...
        try {
            const response = await fetch(`https://moreorless.up.railway.app/api/movies?search=${encodeURIComponent(query)}`);
            const movies = await response.json();
